...
<div class="overlay">
    <form action="#" method="post">
        ...
        <br>
        <div class=""><input class="i1" type="text" name="boardTitle" placeholder="제목을 적어주세요" ></div>
        <br>
        <div>
             <textarea rows="5" cols="13" name="boardContent" class="t1" title="남을 비방하거나 허위 정보를 전파하거나 타인을 모욕하는 말은 사용자 간에 신뢰를 떨어뜨릴 뿐만 아니라 관련 법률에 의해 처벌받을 수 있습니다">
             </textarea>
        </div>
