    ...
    <div id="form-wrapper">
        ...
        <form action="/mypage/info" name="info" id="signUpForm" class="info-form" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="sign_email" name="email" value="${p.email}" >
                <div id="emailHelp" class="form-text"></div>
            </div>
            <div class="mb-3">
                <label for="sign_intro" class="form-label">한 줄 소개</label>
                <input type="text" class="form-control" id="sign_intro" name="introduction" value="${p.introduction}">
            </div>
            <div class="container">
