...
<div id="mypage-side-bar">
    <div id="userInfo">
        <div class="card border-secondary mb-3" >
            <div class="card-body">
                <p class="card-text">닉네임 : ${p.nickname}</p>
                <p class="card-text">아이디 : ${p.personId}</p>
                <p class="card-text">한줄소개 : ${p.introduction}</p>
            </div>
        </div>
                ...
                <div >
                    <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4 border-end">
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link" href="/mypage/room">나의 활동</a>
                            <nav class="nav nav-pills flex-column">
                            ...
                            <a class="nav-link" href="/mypage/info">회원 정보</a>
                            <nav class="nav nav-pills flex-column">
