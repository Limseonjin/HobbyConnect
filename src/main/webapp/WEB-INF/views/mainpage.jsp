    ...
    <div id="main-body">
        ...
        <div id="post-list" class="card">
            <div id="post-list-body" class="card-body">
                <c:forEach var="b" items="${bList}">  ${b.mainBoardId}
                    <div class="card room-post" data-bno="2">
                        <div class="card-header">
                            <h2> ${b.mainBoardTitle}Title (${b.currUser}/${b.maxUser})</h2>
                            <div class="icon">
                        ...
                        <div class="card-body">
                            <p class="contents">content:${b.mainBoardContent}</p>
                            <div class="jcend">
                                <p class="card-text">작성자:${b.personId}</p>
                            </div>
